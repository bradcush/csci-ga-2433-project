...
CREATE TABLE public.personal_information (
	...
	CONSTRAINT personal_information_pk PRIMARY KEY (id_customer)
);
...
-- object: public.mailing_list_email | type: TABLE --
CREATE TABLE public.mailing_list_email (
	type_mailing_list varchar(20) NOT NULL,
	id_email integer NOT NULL,
	CONSTRAINT mailing_list_email_pk PRIMARY KEY (type_mailing_list,id_email)
);
ALTER TABLE public.mailing_list_email OWNER TO postgres;

-- object: mailing_list_fk | type: CONSTRAINT --
ALTER TABLE public.mailing_list_email ADD CONSTRAINT mailing_list_fk FOREIGN KEY (type_mailing_list)
REFERENCES public.mailing_list (type) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;

-- object: email_fk | type: CONSTRAINT --
ALTER TABLE public.mailing_list_email ADD CONSTRAINT email_fk FOREIGN KEY (id_email)
...
ALTER TABLE public.warranty ADD CONSTRAINT order_fk FOREIGN KEY (id_order, date_order)
REFERENCES public."order" (id, date) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;

-- object: warranty_uq | type: CONSTRAINT --
ALTER TABLE public.warranty ADD CONSTRAINT warranty_uq UNIQUE (id_order, date_order);
