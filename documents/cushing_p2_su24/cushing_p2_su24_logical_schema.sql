...
CREATE TABLE public.customer (
	...
	id_member smallint,
	id_personal_information integer,
...
ALTER TABLE public.customer ADD CONSTRAINT personal_information_fk FOREIGN KEY (id_personal_information)
REFERENCES public.personal_information (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;

-- object: customer_uq2 | type: CONSTRAINT --
ALTER TABLE public.customer ADD CONSTRAINT customer_uq2 UNIQUE (id_personal_information);
